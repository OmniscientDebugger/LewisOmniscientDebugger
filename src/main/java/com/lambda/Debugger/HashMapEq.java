...
public final class HashMapEq extends AbstractMap implements Map, Cloneable,
    ...
    /**
     * Rehashes the contents of this map into a new <tt>HashMapEq</tt> instance
    ...
    /**
     * Returns a shallow copy of this <tt>HashMapEq</tt> instance: the keys and
    ...
    /**
     * Save the state of the <tt>HashMapEq</tt> instance to a stream (i.e.,
     * serialize it).
     *
     * @serialData The <i>capacity</i> of the HashMapEq (the length of the
     *		   bucket array) is emitted (int), followed  by the
     *		   <i>size</i> of the HashMapEq (the number of key-value
    ...
    /**
     * Reconstitute the <tt>HashMapEq</tt> instance from a stream (i.e.,
     * deserialize it).
     */
