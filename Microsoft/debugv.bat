...
rem	 MEMORY is the number used to determine when to GC. Currently 80MB => 400k TSs
...
rem	 MAX memory size is 2GB (31 bits). 80MB is generally a good size.
...
java %ddHEAP_SIZE% %ddPATH% %USER_FLAGS%  -DTRACE_LOADER       	%debugger% %1 %2 %3 %4 %5 %6 %7 %8 %9
