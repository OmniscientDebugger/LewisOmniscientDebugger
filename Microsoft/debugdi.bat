...
rem	 debugdi MyProgram  runs the program normally, but doesn't do any instrumentation.

java %ddHEAP_SIZE% %ddPATH% %USER_FLAGS% -DDONT_INSTRUMENT     	%debugger% %1 %2 %3 %4 %5 %6 %7 %8 %9
